...
description: Generates article cover images with 5 dimensions (type, palette, rendering, text, mood) combining 9 color palettes and 6 rendering styles. Default aspect ratio is 2.35:1 (WeChat Official Account standard). Also supports widescreen (16:9) and square (1:1). Use when user asks to "generate cover image", "create article cover", "make cover", or mentions "封面图".
---
...
| `--aspect <ratio>` | 2.35:1 (default, WeChat standard), 16:9, 4:3, 3:2, 1:1, 3:4 |
...
- **Default aspect ratio is 2.35:1** - the standard for WeChat Official Account cover images
